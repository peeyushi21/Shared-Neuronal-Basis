...
firing=load('test2.mat');
firingRatesAverage=firing.test2;
...
%    [2 3] - saccade/time interaction
%    [1 2] - task/saccade interaction
% And one three-way interaction:
%    [1 2 3] - rest
% As explained in the eLife paper, we group stimulus with stimulus/time interaction etc.:

combinedParams = {{1, [1 3]}, {2, [2 3]}, {3}, {[1 2], [1 2 3]}};
margNames = {'task', 'saccade', 'Condition-independent', 'T/S Interaction'};
